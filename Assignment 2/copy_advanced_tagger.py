    ...
    def generate_features_and_labels(data):
        ...
        for conversation in data:
            ...
            for dialog in conversation:
                ...
                if len(previous_dialog_pos) != 0:
                    for item in previous_dialog_pos:
                        dialog_features.append(item)
                previous_dialog_pos = []
                ...
                if postag_object_list is not None:
                    for postag_object in postag_object_list:
                        ...
                        if key in pos_dict:
                            ...
                            pos_dict[key] = 1
                        previous_dialog_pos.append("Previous_POS_" + pos)
                    ...
                    previous_dialog_pos.append("Previous_POS_BLANK")
                ...
                if text.endswith(" /"):
                    ...
                    previous_dialog_pos.append("Previous last char slash: True")
                    previous_dialog_pos.append("Previous last char hyphen: False")
                elif text.endswith("-/") or text.endswith("- /"):
                    dialog_features.append("Last char slash: False")
                    dialog_features.append("Last char hyphen: True")
                    previous_dialog_pos.append("Previous last char slash: False")
                    previous_dialog_pos.append("Previous last char hyphen: True")
                else:
                    dialog_features.append("Last char slash: False")
                    dialog_features.append("Last char hyphen: False")
                    previous_dialog_pos.append("Previous last char slash: False")
                ...
                if "?" in text:
                    ...
                    previous_dialog_pos.append("Previous contains question: True")
                else:
                    dialog_features.append("Contains question: False") 
                    previous_dialog_pos.append("Previous contains question: False")
...
if __name__ == "__main__":
    ...
    train_features, train_labels = AdvancedTagger.generate_features_and_labels(training_set)
    print (train_features[0][1])
    test_features, test_labels = AdvancedTagger.generate_features_and_labels(dev_set)
